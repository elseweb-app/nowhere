// Test-only, in-memory RTCPeerConnection stand-in — same approach as
// packages/client/test/fake-webrtc.js, duplicated rather than shared because it is
// test scaffolding private to each package, not part of either package's public API.
